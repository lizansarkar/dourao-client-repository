...
export default function Footer() {
  return (
    <footer className="container rounded-2xl bg-gray-50 text-gray-700 py-16 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="footer grid-cols-1 md:grid-cols-4 gap-10">
          {/* === কলাম ১: লোগো, টেক্সট এবং সোশ্যাল লিঙ্ক === */}
          <aside className="space-y-6">
            <NavLink to="/">
              <img
                src="/logo-img/logo.png" // আপনার ডার্ক লোগো পাথ এখানে দিন
                alt="Dourao Logo"
            ...
            {/* আপনার লাল মার্ক করা স্থানে সোশ্যাল আইকনসমূহ */}
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2 bg-gray-200 rounded-lg hover:bg-[#BDEE58] transition-all"
              >
              ...
              <a
                href="#"
                className="p-2 bg-gray-200 rounded-lg hover:bg-blue-600 hover:text-white transition-all"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
